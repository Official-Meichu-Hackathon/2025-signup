  ...
  <div class="py-5 px-3 md:px-30 2xl:px-80">
    ...
    >
      <div
        ...
        class="bg-lightblue shadow-lg px-5 py-7 md:p-15 rounded-3xl font-bold text-darkblue"
      >
    ...
    >
      <div
        ref="formRef"
        v-if="formStepOrder !== currentStepOrder"
        class="bg-[#D9D9D9] rounded-3xl px-6 md:px-15 py-4 md:py-8 font-bold text-white transition-colors duration-200"
        :class="canClickCollapsed ? 'cursor-pointer hover:bg-[#C0C0C0]' : 'cursor-default'"
        @click="handleClickCollapsed"
      >
        <p class="text-xl md:text-3xl whitespace-pre">
